...
namespace JurisTempus.Data
{
    public class BillingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder bldr)
        {
            ...
            Run this to apply the required, hasMaxLength to Cases table:

            C:\dox\code\tutorials\BestPracticesEntityValidationModels\src\JurisTempus>
                dotnet ef migrations add SchemaChanges -p ..\JurisTempus.Data -o ..\JurisTempus.Data\Migrations\

            Then update the schema

            C:\dox\code\tutorials\BestPracticesEntityValidationModels\src\JurisTempus>dotnet ef database update
